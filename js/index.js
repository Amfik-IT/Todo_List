...
const taskerApp = (function () {
    ...
    class TaskerView {
                    ...
                    <main class="${className}">
                        <div>
                            ...
                            <div class="create-category__body">
                                <input type="text" class="input-text" onkeyup="this.value = this.value.replace(/[^A-Za-zА-Яа-яЁё\\s]/,'');" placeholder="Enter category name" maxlength="16">
                            </div>
                        </div>
                        <div>
        ...
        changeCategoryName() {
            ...
            input.setAttribute('onkeyup', "this.value = this.value.replace(/[^A-Za-zА-Яа-яЁё\\s]/,'')")
